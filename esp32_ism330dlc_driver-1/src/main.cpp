...
#define I2C_SLAVE_TX_BUF_DISABLE 0
#define I2C_SLAVE_RX_BUF_DISABLE 0
#define I2C_SLAVE_ADDR 0b1101011
...
esp_err_t i2c_master_init(void) {
  ...
  return i2c_driver_install(I2C_MASTER_NUM, conf.mode, I2C_SLAVE_RX_BUF_DISABLE,
...
float lpf(float oldVal, float newVal) { return 0.8 * oldVal + 0.2 * newVal; }
...
extern "C" void app_main() {
  ...
  while (1) {
    ...
    send_data_to_server(pitch, roll, pitchAverage, rollAverage, tilt_left,
                        tilt_right, avgTilt, filteredTilt);
